...
export const NodeDescriptionsMap: Record<NodeType, string> = {
    ...
    [NodeType.MODULO]: 'Performs modulo on the input values - returning the remainder of division',
    ...
    [NodeType.POWER]: 'Returns the value of a base expression taken to a specified power',
    ...
    [NodeType.EXPONENTIAL]: 'Returns E (the base of natural logarithms) raised to a power.',
    ...
    [NodeType.ANALOGOUS_COLOR]: 'Returns the analogous colors of the input color',
    [NodeType.COMPLEMENTARY_COLOR]: 'Returns the complementary color of the input color',
    ...
    [NodeType.FROM_HSL]: 'Returns the hue, saturation & luminance of a given HSL color',
    [NodeType.FROM_RGB]: 'Returns the red, green & blue channels of a given RGB color',
    [NodeType.FROM_HSV]: 'Returns the hue, saturation & value of a given HSV color',
    [NodeType.TO_HSL]: 'Returns a HSL color from a given hue, saturation & luminance',
